...
if(!is_dir($dir)){
	...
	$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productPrice,productDescription,productAmount,productAvailability,productImage1,productPriceBeforeDiscount) values('$category','$subcat','$productname','$productcompany','$productprice','$productdescription','$productsAmount','$productavailability','$productimage1','$productpricebd')");
