...
$_SESSION['msg']="Categoría Actualizada Correctamente!!";
...
<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" name="description" rows="5" required><?php echo  htmlentities($row['categoryDescription']);?> </textarea>
											</div>
										</div>
									<?php } ?>	
