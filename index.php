...
{
$_SESSION['errmsg']="Usuario o contraseña invalida";
$extra="index.php";
$host  = $_SERVER['HTTP_HOST'];
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
...
<head>
	...
	<title>PharmaPoscontrol | Admin login</title>
...
<body>
	...
	<div class="footer">
		<div class="container">
    <b class="copyright" style="text-align: right;">&copy; 2023 Control de punto de venta - <a href="">PharmaPoscontrol-control</a> </b> Todos los derechos reservados.
</div>
