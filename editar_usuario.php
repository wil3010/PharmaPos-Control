...
$sql=mysqli_query($con,"update  admin set username='$username' where id='$pid' ");
...
<head>
	...
	<title>PharmaPost-Control | Editar usuario</title>
...
<div class="control-group">
  <label class="control-label" for="basicinput">Nombre del Usuario</label>
<div class="controls">
<input type="text" username="username"  placeholder="Ingrese el nombre usuario" value="<?php echo htmlentities($row['username']);?>" class="span8 tip" required>
</div>
</div>
